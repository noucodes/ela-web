...
export default function EmberPage() {
  ...
  return (
    <div className={`${styles.page} ${isLight ? styles.lightTheme : ''} ${oswald.variable} ${inter.variable}`}>
      ...
      <nav className={styles.nav}>
        ...
        <div className={styles.navRight}>
          <span className={styles.navHours}>Wed–Sun from 5pm</span>
          <button
      ...
      <div className={styles.hero}>
        ...
        <div className={styles.heroContent}>
          <div className={styles.heroLabel}>
            <span>Now Open — Limited Seats</span>
          </div>
          <h1 className={styles.heroTitle}>
            <div>FIRE</div>
            <div><span className={styles.heroOutline}>FOOD</span></div>
            <div><span className={styles.heroAccent}>PASSION</span></div>
          </h1>
          <p className={styles.heroSubtitle}>
            ELA is where authentic Mediterranean traditions meet bold, modern cooking.
            Every dish is crafted to ignite your senses.
          </p>
        ...
        <div className={styles.aboutInner}>
          <div>
            ...
            <div className={styles.featureList}>
              {[
                { num: '01', title: 'Locally Sourced', desc: 'Fresh produce from trusted local farmers every morning' },
                { num: '02', title: 'Cooked to Order', desc: 'Every dish prepared fresh, never pre-made' },
                { num: '03', title: 'Bold Flavours', desc: 'Authentic spices & techniques from the Mediterranean' },
              ].map(({ num, title, desc }) => (
        ...
        <div className={styles.hoursInner}>
          ...
          <div className={styles.hoursGrid}>
            <div className={styles.hoursCell}>
              <div className={styles.hcDay}>Mon — Tue</div>
              <div className={styles.hcTime}>Closed</div>
              <span className={`${styles.hcBadge} ${styles.badgeClosed}`}>Closed</span>
            </div>
            <div className={styles.hoursCell}>
              <div className={styles.hcDay}>Wednesday</div>
              <div className={styles.hcTime}>5pm – 10pm</div>
              <span className={`${styles.hcBadge} ${styles.badgeOpen}`}>Dinner Only</span>
            </div>
            <div className={styles.hoursCell}>
              <div className={styles.hcDay}>Thursday</div>
              <div className={styles.hcTime}>5pm – 10pm</div>
              <span className={`${styles.hcBadge} ${styles.badgeOpen}`}>Dinner Only</span>
            </div>
            <div className={styles.hoursCell}>
              <div className={styles.hcDay}>Friday — Sat</div>
              <div className={styles.hcTime}>12pm – 11pm</div>
              <span className={`${styles.hcBadge} ${styles.badgeOpen}`}>Lunch &amp; Dinner</span>
            </div>
            <div className={`${styles.hoursCell} ${styles.hoursCellFull}`}>
              <div className={styles.hcDay}>Sunday</div>
              <div className={styles.hcTime}>12pm – 9pm</div>
              <div className={styles.hcNote}>Sunday family roast specials from 12pm</div>
            </div>
          </div>
          <p className={styles.hoursNote}>
            Public holiday hours may differ. Check our Instagram for updates.
          </p>
        </div>
      </section>
      ...
      <footer className={styles.footer}>
        ...
        <div className={styles.footerBottom}>&copy; 2026 ELA Restaurant &nbsp;·&nbsp; Fuego Theme</div>
      </footer>
